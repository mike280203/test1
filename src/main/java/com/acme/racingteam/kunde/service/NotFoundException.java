...
public final class NotFoundException extends RuntimeException {
    ...
    /// Standardkonstruktor für den [KundeService], wenn alle Kunden gesucht werden, aber keine existieren.
    NotFoundException() {
    ...
    /// Konstruktor für den [KundeService] bei fehlerhafter ID.
    ///
    ...
    /// Konstruktor für den [KundeService] bei fehlerhaften Suchparameter.
    ///
